            ...
            <!--div class="row">
                <div class="col-lg-4 col-xs-12 col-sm-12 ">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            <div id="tecnofuturos" style="width: 100%; height: 400px; background-color: #FFFFFF;" ></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-xs-12 col-sm-12 ">
                    <div class="portlet light ">
                        <div class="portlet-title">
                            <div class="caption">
                                <span class="caption-subject bold uppercase font-dark">Estadística por Programa</span>
                            </div>
                ...
                <div class="col-lg-4 col-xs-12 col-sm-12 ">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            <div id="quierosaber" style="width: 100%; height: 400px; background-color: #FFFFFF;" ></div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-4 col-xs-12 col-sm-12 ">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            <div id="emprendimiento" style="width: 100%; height: 400px; background-color: #FFFFFF;" ></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-xs-12 col-sm-12 ">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            <div id="alimentes" style="width: 100%; height: 400px; background-color: #FFFFFF;" ></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-xs-12 col-sm-12 ">
                    <div class="portlet light ">
                        ...
                        <div class="portlet-body">
                            <div id="puntoyseguimos" style="width: 100%; height: 400px; background-color: #FFFFFF;" ></div>
                        </div>
                    </div>
                </div>
            </div-->
